...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.renderMoreLink = function (row, col, hiddenSegs, numData) {
        var _this = this;
        var view = this.view;
        return $('<a class="fc-more"/>')
            .text(this.getMoreLinkText(numData))
...
var DateComponent = /** @class */ (function (_super) {
    ...
    DateComponent.prototype.publiclyTrigger = function (trigger) {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
